...
//	●●●●　TOPICS（お知らせ）をアクティブ　●●●●●●●●●●●●
		"topics" : '<a href="' + protocal_path + 'topics/index.html"><img src="' + absolute_path + 'top/imgs/submenu_topics.gif" alt="TOPICS" width="' + data["other"]["submenu_topics"][tarPage]["off"]["_w"] + '" height="' + data["other"]["submenu_topics"][tarPage]["off"]["_h"] + '" /></a>',
//	●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●
//	○○○○　TOPICS（お知らせ）を非アクティブ　○○○○○○○○○○○
...
//	●●●●　BLOG（社長ブログ）をアクティブ　●●●●●●●●●●●●
		"blog" : '<a href="' + protocal_path + 'blog/index.html"><img src="' + absolute_path + 'top/imgs/submenu_blog.gif" alt="BLOG" width="' + data["other"]["submenu_blog"][tarPage]["off"]["_w"] + '" height="' + data["other"]["submenu_blog"][tarPage]["off"]["_h"] + '" /></a>',
//	●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●
//	○○○○　BLOG（社長ブログ）を非アクティブ　○○○○○○○○○○○
...
//	■■■■■　不活性設定　■■■■■
//			if (tarName != "submenu_blog" && tarName != "submenu_archives" && tarName != "submenu_topics") {
//			if (tarName != "submenu_archives") {
      if(true){
//	■■■■■■■■■■■■■■■■■
